...
public class CheckNewsReceiver extends BroadcastReceiver {
    ...
    private static final String TAG = "CheckNewsReceiver";
    @Override
    public void onReceive(Context context, Intent intent) {
        this.mContext = context;
        client = new OkHttpClient();
        Log.d(TAG, "onReceive: 广播机制中的轮询执行了一次");
    ...
    private void noticeComponent(String projNum, String code) {
        NotificationManager manager = (NotificationManager) mContext.getSystemService(Context.NOTIFICATION_SERVICE);
        Intent intent = new Intent(mContext ,LoginActivity.class);
        PendingIntent pi = PendingIntent.getActivity(mContext,0,intent,0);
        String c = getNotice(projNum,code);
        Notification notice = new NotificationCompat.Builder(mContext)
                .setAutoCancel(true)
                .setContentText(c)
                ...
                .setLargeIcon(BitmapFactory.decodeResource(mContext.getResources(),R.drawable.f))
                .build();
        manager.notify(1,notice);
    }

    private void noticeUser(String projNum, String code) {
        NotificationManager manager = (NotificationManager) mContext.getSystemService(Context.NOTIFICATION_SERVICE);
        Intent intent = new Intent(mContext ,LoginActivity.class);
        PendingIntent pi = PendingIntent.getActivity(mContext,0,intent,0);
        ...
        Notification notice = new NotificationCompat.Builder(mContext)
                ...
                .setLargeIcon(BitmapFactory.decodeResource(mContext.getResources(),R.drawable.b))
                .build();
        manager.notify(1,notice);
    }
